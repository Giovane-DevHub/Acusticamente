      ...
      <div class="panel-card" style="margin-bottom: 0;">
        ...
        <div class="table-responsive">
          <table class="data-table">
            ...
            <tbody>
              ${f.map(i=>{const m=i.papel==="admin"?"Administrador":i.papel==="professor"?"Professor":"Atendente",x=Se(i),g=et(x);return`
                    <tr>
                      <td>
                        <div style="display: flex; align-items: center; gap: 8px;">
        ...
        <div class="panel-card">
          ...
          <div class="table-responsive">
            <table class="data-table">
              ...
              <tbody>
                ${P.length===0?'<tr><td colspan="6" style="text-align: center; color: var(--text-muted); padding: 24px;">Nenhum aluno atende aos filtros aplicados.</td></tr>':P.map(w=>{const H=u.find(Oe=>Oe.id===w.planoId),se=w.status==="ativo",ke=k.isStudentOverdue(w.id);return`
                            <tr>
